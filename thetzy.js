...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = '㑒 𝑿𝒆𝒛 ϟ〽️' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = '[⫹⫺ - 㑒 𝑿𝒆𝒛 ϟ〽️]' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = '𝑿𝒆𝒛 ϟ' //ubah jadi nama mu, note tanda ' gausah di hapus!
...
global.packname = '𝑿𝒆𝒛 ϟ'
global.ownerr = ['㑒 𝑿𝒆𝒛 ϟ〽️']
global.author = '[⫹⫺ - 㑒 𝑿𝒆𝒛 ϟ〽️]'
global.prefa = ['','!','.',',','🐤','🗿']
global.sp = '⭔'
global.mess = {
